...
class Project02UITests: XCTestCase {
        ...
        func testLabelCopiesTextField() throws {
            ...
            app.textFields["TextField1"].typeText("Kelvin")
            app.keyboards.buttons["Return"].tap()
            
            XCTAssertTrue(app.staticTexts["Label1"].label == "Kelvin")
        ...
        func testLabelCopiesTextField2() throws {
            ...
            XCTAssertTrue(app.staticTexts["Label2"].label == "Reid")
